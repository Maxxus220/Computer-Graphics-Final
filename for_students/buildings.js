...
let brickTexbw = new T.TextureLoader().load("./images/2ch-brick_bw.jpg");
let brickBump = new T.TextureLoader().load("./images/2ch-brick_bump.jpg");

let building1Tex = new T.TextureLoader().load("./images/TopTex.jpg");
let building1Texbw = new T.TextureLoader().load("./images/TopTex_bw.jpg");
let building1Bump = new T.TextureLoader().load("./images/TopTexBump.jpg");

let doorTex = new T.TextureLoader().load("./images/DoorTex.jpg");
let doorTexbw = new T.TextureLoader().load("./images/DoorTex_bw.jpg");

let tanBrickTex = new T.TextureLoader().load("./images/TanBrick.jpg");
let tanBrickTexbw = new T.TextureLoader().load("./images/TanBrick_bw.jpg");
let tanBrickBump = new T.TextureLoader().load("./images/TanBrick_bump.jpg");

let gravelRoofTex = new T.TextureLoader().load("./images/GravelRoof.jpg");
let gravelRoofTexbw = new T.TextureLoader().load("./images/GravelRoof_bw.jpg");
let gravelRoofBump = new T.TextureLoader().load("./images/GravelRoof_bump.jpg");

let doubleDoorTex = new T.TextureLoader().load("./images/DoubleWoodDoor.jpg");
let doubleDoorTexbw = new T.TextureLoader().load("./images/DoubleWoodDoor_bw.jpg");

let windowTex = new T.TextureLoader().load("./images/Window.jpg");
let windowTexbw = new T.TextureLoader().load("./images/Window_bw.jpg");

export class GrBuilding1 extends GrObject {
    constructor(params = {}) {
        let building1 = new T.Group();

        let brickMat = new T.MeshStandardMaterial({color:"white",map:brickTex,bumpMap:brickBump});
        let baseGeom = new T.BoxGeometry(2,1,1);
        let base = new T.Mesh(baseGeom,brickMat);
        building1.add(base);

        let buildTopGeom = new T.BufferGeometry();
        let buildTopMat = new T.MeshStandardMaterial({color:"white",map:building1Tex,bumpMap:building1Bump});
...
export class GrBuilding1_bw extends GrObject {
    constructor(params = {}) {
        let building1 = new T.Group();

        let brickMat = new T.MeshStandardMaterial({color:"white",map:brickTexbw,bumpMap:brickBump});
        let baseGeom = new T.BoxGeometry(2,1,1);
        let base = new T.Mesh(baseGeom,brickMat);
        building1.add(base);

        let buildTopGeom = new T.BufferGeometry();
        let buildTopMat = new T.MeshStandardMaterial({color:"white",map:building1Texbw,bumpMap:building1Bump});
        ...
        let doorGeom = new T.BoxGeometry(0.3, 0.6, 0.05);
        let doorMat = new T.MeshStandardMaterial({color:"white",map:doorTexbw});
        let door = new T.Mesh(doorGeom,doorMat);
        door.position.z = 0.48;
        door.position.y = -0.2;
...
export class GrBuilding2 extends GrObject {
    constructor(params = {}) {
        ...
        let baseMat = new T.MeshStandardMaterial({color:"white",map:tanBrickTex,bumpMap:tanBrickBump});
        let base = new T.Mesh(baseGeom,baseMat);
        building2.add(base);

        let roofGeom = new T.BoxGeometry(2.2,0.2,1.2);
        let roofMat = new T.MeshStandardMaterial({color:"white",map:gravelRoofTex,bumpMap:gravelRoofBump});
...
export class GrBuilding2_bw extends GrObject {
    constructor(params = {}) {
        let building2 = new T.Group();

        let baseGeom = new T.BoxGeometry(2,2,1);
        let baseMat = new T.MeshStandardMaterial({color:"white",map:tanBrickTexbw,bumpMap:tanBrickBump});
        let base = new T.Mesh(baseGeom,baseMat);
        building2.add(base);

        let roofGeom = new T.BoxGeometry(2.2,0.2,1.2);
        let roofMat = new T.MeshStandardMaterial({color:"white",map:gravelRoofTexbw,bumpMap:gravelRoofBump});
        let roof = new T.Mesh(roofGeom,roofMat);
        roof.position.y = 1.1;
        building2.add(roof);

        let doorGeom = new T.BoxGeometry(0.6, 0.6, 0.05);
        let doorMat = new T.MeshStandardMaterial({color:"white",map:doubleDoorTexbw});
        let door = new T.Mesh(doorGeom,doorMat);
        door.position.y = -0.7;
        door.position.z = 0.48;
        building2.add(door);
        ...
        let windowGeom = new T.BoxGeometry(0.2,0.4,0.05);
        let windowMat = new T.MeshStandardMaterial({color:"white",map:windowTexbw});
